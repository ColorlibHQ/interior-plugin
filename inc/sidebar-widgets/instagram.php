...
----------------------------------------*/
class interior_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('interior_instagram_photo',esc_html__('[ Interior ] Intagram Photo','interior-companion'),array(
			'description' => esc_html__('Interior Instagram Photo Widget','interior-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'interior-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'interior-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'interior-companion'); ?></label>
...
if(!function_exists('interior_instagram_widgets')):
	function interior_instagram_widgets(){
		register_widget('interior_instagram_photo');
	}
	add_action('widgets_init','interior_instagram_widgets');
endif;
