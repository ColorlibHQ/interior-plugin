...
class Interior_newsletter_widget extends WP_Widget {
    ...
    if( $desc ){
        ...
        <div class="form-wrap" id="mc_embed_signup">
            <form target="_blank" action="<?php echo esc_url( $actionurl ); ?>" method="post" class="interior_mailchimp_newsletter_widget">

                <div class="subscribe_form input-group align-items-center">
                    <input class="form-control" name="EMAIL" placeholder="<?php esc_html_e( 'Your Email Address', 'interior-companion' ); ?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Your Email Address '" required="" type="email">
    ...
    public function form( $instance ) {
        ...
        if ( isset( $instance[ 'desc' ] ) ) {
            ...
            $desc = esc_html__( 'Subscribe newsletter to get all updates about discount and offers.', 'interior-companion' );;
        }
        ...
        <p>
            ...
            <p class="description"><?php esc_html_e( 'Enter here your MailChimp action URL.' ,'interior-companion'); ?> </p>
