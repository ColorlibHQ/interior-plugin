...
class Interior_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'interior_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Interior ] Social Links', 'interior-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'interior-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'interior-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'desc' ) ); ?>"><?php esc_html_e( 'Short Description:' ,'interior-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'interior-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'interior-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'interior-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'interior-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'interior-companion'); ?></label>
...
} // Class interior_social_links ends here


// Register and load the widget
function interior_social_links_widget_load() {
	register_widget( 'Interior_social_links' );
}
add_action( 'widgets_init', 'interior_social_links_widget_load' );