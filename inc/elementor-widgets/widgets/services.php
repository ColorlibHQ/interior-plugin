...
/**
 *
 * Interior elementor service section widget.
 *
 * @since 1.0
 */
class Interior_Services extends Widget_Base {
	...
	public function get_title() {
		return __( 'Services', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'service_content',
			[
				'label' => __( 'Services content', 'interior-companion' ),
			]
        );
            ...
            'services', [
                ...
                'fields' => [
                    [
                        ...
                        'default' => __( 'Planing', 'interior-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        ...
                        'default' => __( 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet', 'interior-companion' ),
                    ],
                    [
                        'name' => 'item_img',
                        'label' => __( 'Item Bg Image', 'interior-companion' ),
                        'description' => __( 'The theme preffered for the Bg Image size 640x570px ', 'interior-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [
                        'item_title' => __( 'Planing', 'interior-companion' ),
                        'item_text'  => __( 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet', 'interior-companion' ),
                        'item_img'   => [
                            'url' => Utils::get_placeholder_image_src()
                        ],
                    ],
                    [
                        'item_title' => __( 'Architecture', 'interior-companion' ),
                        'item_text'  => __( 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet', 'interior-companion' ),
                        'item_img'   => [
                            'url' => Utils::get_placeholder_image_src()
                        ],
                    ...
                    [
                        'item_title' => __( '3D Design', 'interior-companion' ),
                        'item_text'  => __( 'Aenean sollicitudin, lorem quis bibendum auctor, nisi elit consequat ipsum, nec sagittis sem nibh id elit. Duis sed odio sit amet', 'interior-companion' ),
                        'item_img'   => [
                            'url' => Utils::get_placeholder_image_src()
                        ],
