...
/**
 *
 * Interior elementor business expert section widget.
 *
 * @since 1.0
 */
class Interior_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'interior-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'interior-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'interior-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'interior-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'interior-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'interior-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'interior-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'interior-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'interior-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'interior-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'interior-companion' ),
    ...
    $this->add_control(
        'icon_bg_col', [
            'label' => __( 'Icon Bg Color', 'interior-companion' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
