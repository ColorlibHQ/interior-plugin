...
/**
 *
 * Interior elementor Interior categories section widget.
 *
 * @since 1.0
 */
class Interior_Listing_Categories extends Widget_Base {

	public function get_name() {
		return 'interior-listing-categories';
	}

	public function get_title() {
		return __( 'Popular Listing Cat.', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		// ----------------------------------------  Interior categories content ------------------------------
		$this->start_controls_section(
			'interior_content',
			[
				'label' => __( 'Popular Listing Cat. content', 'interior-companion' ),
			]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Discover', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Most Popular Categories', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'selected_cats',
            [
                'label' => esc_html__( 'Select Categories To Show', 'interior-companion' ),
                'type' => Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple' => true,
                'options'   => interior_get_taxonomies(),
                // 'options'   => [
                //     '1' => 'eita',
                //     '2' => 'oita'
                // ],
		...
		$this->add_control(
			'cat_order',
			[
				'label'         => esc_html__( 'Category Order', 'interior-companion' ),
		...
		$this->add_control(
			'cat_item',
			[
				'label'         => esc_html__( 'Item To Show', 'interior-companion' ),
    ...
    // interior_related_items('', $post_item, $post_order);
    ?>
