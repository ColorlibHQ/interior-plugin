...
/**
 *
 * Interior elementor facilities section widget.
 *
 * @since 1.0
 */
class Interior_Facilities extends Widget_Base {
	...
	public function get_title() {
		return __( 'App Facilities', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'facilities_content',
			[
				'label' => __( 'Facilities content', 'interior-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => 'Save your time to <br>using interior',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Facilities', 'interior-companion' ),
		...
		$this->add_control(
            'facilities', [
                ...
                'fields' => [
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Select Icon', 'interior-companion' ),
                        'label_block' => true,
            ...
            <div class="row">
                ...
                if( is_array( $facilities ) && count( $facilities ) > 0 ) {
                    foreach( $facilities as $item ) {
                        $item_icon = ( !empty( $item['item_icon'] ) ) ? INTERIOR_DIR_ICON_IMG_URI . $item['item_icon'] : '';
