...
/**
 *
 * Interior elementor home appointment section widget.
 *
 * @since 1.0
 */
class Interior_Contact_Project extends Widget_Base {
	...
	public function get_title() {
		return __( 'Contact for Project', 'interior-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Contact for Project Settings', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'bg_img',
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Let’s discuss for a project', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
        ...
        $this->start_controls_section(
            'home_contact_sec_style', [
                'label' => __( 'Home Contact Section Styles', 'interior-companion' ),
        ...
        $this->add_control(
			'btn_hvr_border_bg_col', [
				'label' => __( 'Button Hover Border & Bg Color', 'interior-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <!-- Estimate_area start  -->
    <div class="Estimate_area overlay" <?php echo interior_inline_bg_img( esc_url( $bg_img ) ); ?>>
        <div class="container">
            <div class="row">
