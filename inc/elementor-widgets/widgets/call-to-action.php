...
/**
 *
 * Interior elementor call to action section section widget.
 *
 * @since 1.0
 */
class Interior_Call_To_Action extends Widget_Base {

	public function get_name() {
		return 'interior-call-to-action';
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Call To Action Section', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'bg_img',
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Sec Title', 'interior-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( '100% secure and safe', 'interior-companion' ),
            ]
        );  
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Esteem spirit temper too say adieus who direct esteem. It look estee luckily or picture placing drawing.', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'btn_label',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( '+10 672 457 356', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
        ...
        $this->start_controls_section(
            'left_sec_style', [
                'label' => __( 'Top Section Styles', 'interior-companion' ),
        ...
        $this->add_control(
			'button_hover_col', [
				'label' => __( 'Button Hover Bg Color', 'interior-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Overlay Color Styles', 'interior-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
			'sec_title_col', [
				'label' => __( 'Bg Overlay Color', 'interior-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <!-- call_to_action_area  -->
    <div class="contact_action_area" <?php echo interior_inline_bg_img( esc_url( $bg_img ) ); ?>>
        <div class="container">
