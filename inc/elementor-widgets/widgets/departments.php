...
/**
 *
 * Interior elementor departments section widget.
 *
 * @since 1.0
 */
class Interior_Departments extends Widget_Base {

	public function get_name() {
		return 'interior-departments';
	}

	public function get_title() {
		return __( 'Departments', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'interior-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'interior-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'interior-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'interior-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'interior-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Button Text', 'interior-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'interior-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                    ...
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'interior-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                        'btn_text'   => __( 'Learn More', 'interior-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'interior-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                        'btn_text'   => __( 'Learn More', 'interior-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'interior-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                        'btn_text'   => __( 'Learn More', 'interior-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'interior-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                        'btn_text'   => __( 'Learn More', 'interior-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'interior-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'interior-companion' ),
                        'btn_text'   => __( 'Learn More', 'interior-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'interior-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'interior_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
