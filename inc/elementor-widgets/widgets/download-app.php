...
/**
 *
 * Interior elementor download app section widget.
 *
 * @since 1.0
 */
class Interior_Download_App extends Widget_Base {

	public function get_name() {
		return 'interior-download-app';
	}

	public function get_title() {
		return __( 'Download App', 'interior-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Download App content', 'interior-companion' ),
			]
        );
        $this->add_control(
            'sec_img',
            [
                'label' => esc_html__( 'Big Image', 'interior-companion' ),
                'description' => esc_html__( 'Best size is 457x480', 'interior-companion' ),
        ...
        $this->add_control(
            'left_img',
            [
                'label' => esc_html__( 'Left Small Image', 'interior-companion' ),
                'description' => esc_html__( 'Best size is 195x220', 'interior-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
                    'url'   => Utils::get_placeholder_image_src(),
        ...
        $this->add_control(
            'bottom_img',
            [
                'label' => esc_html__( 'Bottom Small Image', 'interior-companion' ),
                'description' => esc_html__( 'Best size is 195x220', 'interior-companion' ),
                'type' => Controls_Manager::MEDIA,
                'label_block' => true,
                'default'     => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Right Sections', 'interior-companion' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Download app to get interior from Everywhere', 'interior-companion' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Apple Sections', 'interior-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'apple_big_text',
            [
                'label' => esc_html__( 'Big Text', 'interior-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Available', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'apple_small_text',
            [
                'label' => esc_html__( 'Small Text', 'interior-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'on App Store', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'apple_url',
            [
                'label' => esc_html__( 'Apple Store URL', 'interior-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Play Store Sections', 'interior-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Download', 'interior-companion' ),
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'from Play Store', 'interior-companion' ),
            ]
        );
        $this->add_control(
            'playstore_url',
            [
                'label' => esc_html__( 'Play Store URL', 'interior-companion' ),
                'type' => Controls_Manager::URL,
                'label_block' => true,
                'default'   => [
                    'url' => '#'
    ...
    $sec_img = !empty( $settings['sec_img']['id'] ) ? wp_get_attachment_image( $settings['sec_img']['id'], 'interior_video_big_thumb_457x480', '', array( 'alt' => $sec_title ) ) : '';
    $left_img = !empty( $settings['left_img']['id'] ) ? wp_get_attachment_image( $settings['left_img']['id'], 'interior_download_app_small_thumb_195x220', '', array( 'alt' => $sec_title ) ) : '';
    $bottom_img = !empty( $settings['bottom_img']['id'] ) ? wp_get_attachment_image( $settings['bottom_img']['id'], 'interior_download_app_small_thumb_195x220', '', array( 'alt' => $sec_title ) ) : '';
