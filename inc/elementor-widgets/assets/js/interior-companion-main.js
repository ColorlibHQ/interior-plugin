(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".interior-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".interior-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".interior-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.interior-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.interior-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.interior-subscribe-newsletter-area');
    if ($subscribe.length) {
